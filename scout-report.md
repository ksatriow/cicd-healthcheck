...
> `-` _298 packages removed_  
> `⎌` _17 packages changed (_`↑` _0 upgraded_, `↓` _17 downgraded)_  
> _354 packages unchanged_
...
| `-` | is-ci                                 | npm  |         | 3.0.1            |
| `↓` | is-core-module                        | npm  | 2.12.0  | 2.13.0           |
...
| `↓` | is-unicode-supported                  | npm  | 0.1.0   | 1.3.0            |
...
| `↓` | string_decoder                        | npm  | 1.1.1   | 1.3.0            |
| `↓` | strip-ansi                            | npm  | 7.0.1   | 7.1.0            |
